      ...
      questions: [
        {
          ...
          answer: `Il costo di un sito web dipende da molti fattori: complessità, funzionalità richieste, tempistiche e obiettivi. Ogni progetto viene valutato individualmente in base alle tue esigenze. <a href='${langPrefix}/contact' aria-label='Apri pagina contatti' class='text-blue-600 dark:text-blue-500 underline '>Contattami</a> per ricevere un preventivo personalizzato.`
        },
        {
          question: "Quanto tempo serve per realizzare un sito web?",
          answer: `I tempi di realizzazione variano in base alla complessità del progetto. Un sito vetrina può richiedere 3-4 settimane, mentre progetti più complessi con funzionalità avanzate possono richiedere 2-3 mesi o più. Ti fornirò sempre una tempistica chiara all'inizio del progetto. Puoi vedere esempi di lavori già completati nella pagina <a href='${langPrefix}/projects' aria-label='Vai alla pagina progetti' class='text-blue-600 dark:text-blue-500 underline'>Progetti</a>.`
        },
        {
        ...
        },
        {
          ...
          answer: "Mi specializzo nella realizzazione di siti con <a href='https://squarespace.com' aria-label='Apri sito Squarespace' target='_blank' rel='noopener noreferrer' class='text-blue-600 dark:text-blue-500 underline '>Squarespace</a> e <a href='https://framer.com' aria-label='Apri sito Framer' target='_blank' rel='noopener noreferrer' class='text-blue-600 dark:text-blue-500 underline '>Framer</a>, entrambe ottime per design moderni e gestione contenuti semplice. Posso anche sviluppare siti completamente da codice per esigenze specifiche, ma questo richiede tempi e costi maggiori."
        }
      ]
    },
    banner: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            text: "I Servizi sono eseguiti secondo il brief e le specifiche concordate. Di norma i siti vengono realizzati su piattaforme SaaS come <a href='https://squarespace.com' aria-label='Apri sito Squarespace' target='_blank' rel='noopener noreferrer' class='text-blue-600 dark:text-blue-500 underline '>Squarespace</a> o <a href='https://framer.com' aria-label='Apri sito Framer' target='_blank' rel='noopener noreferrer' class='text-blue-600 dark:text-blue-500 underline '>Framer</a>; lo sviluppo in codice è possibile esclusivamente per esigenze complesse e sarà specificato nell'offerta."
          },
          {
            type: "paragraph",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "paragraph",
            text: `Per richieste di progetto deve essere utilizzato esclusivamente il form dedicato disponibile nella <a <a href='${langPrefix}/contact' aria-label='Vai alla pagina contatti' class='text-blue-600 dark:text-blue-500 underline'>pagina di contatto</a>. Per qualsiasi questione relativa alla presente Informativa o all'esercizio dei diritti spettanti, contattare i riferimenti sopra indicati. Non è stato nominato un Data Protection Officer (DPO).`
          }
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "paragraph",
            text: "L'esercizio di tali diritti può essere effettuato mediante richiesta scritta indirizzata a <a href='mailto:info@davidelamarca.com' aria-label='Invia email' class='text-blue-600 dark:text-blue-500 underline'>info@davidelamarca.com</a>. Le richieste saranno evase nei termini e secondo le modalità previste dal GDPR. Il Titolare potrà richiedere informazioni ragionevoli per verificare l'identità dell'Interessato qualora ciò sia necessario per tutelare i diritti e la sicurezza; salvo casi eccezionali, non è richiesto l'invio di documenti di identità per le richieste ordinarie."
          },
          {
            type: "paragraph",
